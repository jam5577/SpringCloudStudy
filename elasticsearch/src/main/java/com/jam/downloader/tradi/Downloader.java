package com.jam.downloader.tradi;
...
public class Downloader {
    ...
    private String storageLocation = "E:\\图片\\SomeThing\\pix_result\\";
    ...
    public Downloader(String url, int threadCount) {
        ...
        this.storageLocation = storageLocation + url.substring(url.lastIndexOf('/') + 1);
        this.logger = new Logger(storageLocation + ".log", url, threadCount);
    }

    public Downloader(String url, int threadCount, String name) {
        this.url = url;
        this.threadCount = threadCount;
        this.canceled = new AtomicBoolean(false);
        ...
        this.storageLocation = storageLocation + name + "\\" + url.substring(url.lastIndexOf('/') + 1);
        this.logger = new Logger(storageLocation + ".log", url, threadCount);
    }
    ...
    public static void main(String[] args) {
        new Downloader("https://www.xiurenb.net/uploadfile/202105/23/12183332537.jpg", DEFAULT_THREAD_COUNT, "露娜").start();
    }
}
