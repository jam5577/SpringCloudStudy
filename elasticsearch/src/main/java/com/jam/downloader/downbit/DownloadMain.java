package com.jam.downloader.downbit;

import com.jam.downloader.downbit.thread.DownloadThread;
import com.jam.downloader.downbit.thread.LogThread;
import com.jam.downloader.downbit.util.FileUtils;
import com.jam.downloader.downbit.util.HttpUtils;
import com.jam.downloader.downbit.util.LogUtils;
...
public class DownloadMain {
    ...
    private final String PATH = "E:\\图片\\SomeThing\\pix_result\\";
    ...
    public static void main(String[] args) throws Exception {
        //LogUtils.DEBUG = true;
        args = new String[]{"https://t.xiurenb.net/Uploadfile/202203/15/7C163222327.jpg"};
        ...
        try (RandomAccessFile oSavedFile = new RandomAccessFile(fileName, "rw")) {
            for (int i = 0; i < DOWNLOAD_THREAD_NUM; i++) {
                try (BufferedInputStream bis = new BufferedInputStream(
                        new FileInputStream(PATH + fileName + FILE_TEMP_SUFFIX + i))) {
