...
import com.jam.app.handler.*;
import com.jam.app.service.impl.UserServiceImpl;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/login", "/toRegister", "/user/register", "/", "/user/updateUser", "/doc.html").permitAll()
